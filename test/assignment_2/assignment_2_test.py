...
class Test(unittest.TestCase):
    def test_assignment(self):
        filepath = "../../resource/test_assignment2.txt"
       # creating spark session
        ...
        expected_rdd=['DEBUG,2017-03-24T13:56:38+00:00,ghtorrent-46 -- ghtorrent.rb: Repo agco/harvesterjs exists', 'WARN,2017-03-23T11:04:43+00:00,ghtorrent-32 -- ght_data_retrieval.rb: Error processing event. Type: IssueCommentEvent, ID: 5531718847, Time: 64 ms', 'DEBUG,2017-03-23T10:44:44+00:00,ghtorrent-14 -- api_client.rb: Sleeping for 931 seconds', 'DEBUG,2017-03-23T09:36:14+00:00,ghtorrent-42 -- api_client.rb: Sleeping for 1441 seconds']
        ...
        df_expec = spark.createDataFrame(data1,
                                   ["log message", "timestamp", "downloader", "repository_clients", "commit_message"])
